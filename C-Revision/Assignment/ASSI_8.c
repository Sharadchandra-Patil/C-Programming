...
int main(void)
{
    ...
    do
    {
        ...
        {
        case 0:
            printf("Bye bye ...Thank you for using application...");
            exit(0);
        case 1:
            find_mov_by_name();
            break;
        ...
        case 3:
            ...
            break;
        default:
            printf("Warning....Invalid choice enterd.\nPlease enter valid choice...");
        }
    } while (1);
...
void find_mov_by_name(void)
{
    ...
    while (trav != NULL)
    {
        // = strstr(trav->obj.title, name);
        if (trav->obj.title == name)
        {
            printf("%d  %s  %s ", trav->obj.movie_id, trav->obj.title,
                   trav->obj.genre);
            return;       
            //flag = 0;
        }
